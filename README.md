...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'g'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-g@main/recipes/<cuisine>/<diet>/<slug>.json
```
